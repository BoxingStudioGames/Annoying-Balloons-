...
background:setFillColor( 0,128,0)
...
brick01 = display.newImageRect("bg/brick4.png",200,570)
brick01.x = display.contentCenterX-70
brick01.y = display.contentCenterY
screenGroup:insert(brick01)

brick02 = display.newImageRect("bg/brick3.png",200,570)
...
function Move01 ( )
print 'acress1'
TransMove01=transition.to(  enemy06 , { onStart = PlaySound , x = display.contentWidth+600 ,  time = 1000, delay = 1000, onComplete = Move02 } )
...
function Move02 ( )
print 'acress2'
TransMove02=transition.to(  enemy06 , { onStart =  PlaySound , x = display.contentWidth-600, time = 4000, delay = 1000,  onComplete = Move01 } )
...
function  Move03 ( )
  --print 'up 1'
  TransMove03=transition.to(  enemy07 , { onStart = PlaySound , y = display.contentCenterY-600 ,  alpha = 0.10, time = 1000, delay = 1000, onComplete = Move04 } )
...
function  Move04( )
    --print 'up 2'
   TransMove04=transition.to(  enemy07 , { onStart =  PlaySound , y = display.contentCenterY+600, alpha = 1,  time = 1000, delay = 1000,  onComplete = Move03 } )
...
if event.phase == "began" and count == 35 then 
print "touch swirl"
cleanUp();
audio.play(soundBeep, {channel = 5})
audio.stop( Tick )
...
storyboard.gotoScene( "backworld0903", zoomOutIn,400)
