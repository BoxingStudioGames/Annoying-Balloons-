...
--local life = 3
local count = 10
 metadata.timeLimit = 30;

metadata.Starcount05 = 0;  
...
badStar001 = balloonClass02.new02()
screenGroup:insert(badStar001)

badStar002 = balloonClass02.new02()
screenGroup:insert(badStar002)

badStar003 = balloonClass02.new02()
screenGroup:insert(badStar003)

badStar004 = balloonClass02.new02()
screenGroup:insert(badStar004)
...
cover1 = display.newImage("bg/cover.png",display.contentWidth*2,display.contentWidth*2)
...
function BadstarTouch001 (event)
...
trans04 = transition.to( badStar001, { time = 1000, x = math.random (70, display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil} )

trans05 = transition.to( badStar002, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70, display.contentHeight), onComplete = nil } )

trans06 = transition.to( badStar003, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70, display.contentHeight), onComplete = nil } )

trans07 = transition.to( badStar004, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70, display.contentHeight), onComplete = nil } )
...
if (count == 0 and levels[6] == 2 ) then 

print "you have unlocked level 6"
...
badStar001:addEventListener( "touch",BadstarTouch001 )
badStar002:addEventListener( "touch",BadstarTouch001 )
badStar003:addEventListener( "touch",BadstarTouch001 )
badStar004:addEventListener( "touch",BadstarTouch001 )
