-----------------------------------------------------------------------------------------
--
-- level012.lua/ fianal level of world / 02
--
-------------------------------------------vars----------------------------------------------
...
-- background
 ...
 local background = display.newImageRect("bg/bg12.png", 320, 570)
...
trans07 = transition.to( enemy06, { time = 100.80, x = math.random (70,display.contentWidth), y = math.random (70, display.contentHeight), onComplete = nil } )
...
trans09 = transition.to( NotStar01, { time = 100.80, x = math.random (70,display.contentWidth), y = math.random (70, display.contentHeight), onComplete = nil } )
...
storyboard.gotoScene( "backworld01203", zoomOutIn,400)
