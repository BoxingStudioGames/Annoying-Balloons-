...
--local life = 3
 local count = 32
 metadata.timeLimit = 48;

metadata.Starcount08 = 0;  
...
balloon018 = JamiacanClass.new ()
screenGroup:insert(balloon018)

balloon019 = JamiacanClass.new ()
--balloon05:scale( 1,1 )
screenGroup:insert(balloon019)

balloon020 = JamiacanClass.new ()
---balloon07:scale( 1, 1 )
 screenGroup:insert(balloon020)

balloon021 = JamiacanClass.new ()
--balloon08:scale( 1, 1 )
screenGroup:insert(balloon021)
--[[
balloon021 = JamiacanClass.new ()
--balloon021: scale( 1, 1 )
screenGroup:insert(balloon021)
--]]
balloon022 = JamiacanClass.new ()
--balloon021: scale( 1, 1 )
screenGroup:insert(balloon022)

balloon023 = JamiacanClass.new ()
--balloon021: scale( 1, 1 )
screenGroup:insert(balloon023)
...
----------------------------back of wall-----------------------------------
brick01 = display.newImageRect("bg/brick6.png",200,570)
brick01.x = display.contentCenterX-70
brick01.y = display.contentCenterY
screenGroup:insert(brick01)

brick02 = display.newImageRect("bg/brick5.png",200,570)
brick02.x = display.contentCenterX+70
...
balloon013 = balloonClass.new ()
 screenGroup:insert(balloon013)

balloon014 = balloonClass.new ()
 screenGroup:insert(balloon014)

balloon015 = balloonClass.new ()
 screenGroup:insert(balloon015)

  balloon016 = balloonClass.new ()
 screenGroup:insert(balloon016)

balloon017 = balloonClass.new ()
 screenGroup:insert(balloon017)
...
function MoveWalls ( )
    ...
    if count == 8 then 
     ...
     transition.to( brick01, {x = brick01.x-200, onComplete = nil} )

    transition.to( brick02, {x = brick02.x+200, onComplete = nil} )


     else  

    transition.to( brick01, {x = brick01.x-10, onComplete = nil} )

    transition.to( brick02, {x = brick02.x+10, onComplete = nil} )
...
trans16 = transition.to( balloon013, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil} )

trans17 = transition.to( balloon014, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans18 = transition.to( balloon015, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans19 = transition.to( balloon016, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans20 = transition.to( balloon017, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans21 = transition.to( balloon018, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil} )

trans22 = transition.to( balloon019, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans23 = transition.to( balloon020, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans24 = transition.to( balloon021, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans25 = transition.to( balloon022, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans29 = transition.to( balloon023, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )
 ...
 function rotate ()
    if ( reverse == 0 ) then
      print "front"
        ...
        --[[
        transition.to( balloon01, {  time=500,  alpha =0.10,  delay = 6000, transition=easing.inOutCubic } )
...
--[[
        transition.to( balloon01, {  time=500,  alpha = 1,  delay = 6000, transition=easing.inOutCubic } )
...
if event.phase == "began"  and count == 9 then 
print "touch swirl"
cleanUp();
audio.play(soundBeep, {channel = 5})
audio.stop( Tick )
...
transition.resume( trans21)
transition.resume( trans22)
transition.resume( trans23)
transition.resume( trans24)
transition.resume( trans25)
...
transition.cancel(trans21 )
transition.cancel(trans22 )
transition.cancel(trans23 )
transition.cancel(trans24 ) 
transition.cancel(trans25 ) 
