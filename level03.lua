...
function  starcount( event )
  ...
  metadata.Starcount03 = metadata.Starcount03 +1 
...
timer01 = timer.performWithDelay(1000,timerDown,60)
 ...
 if event.phase == "began" then 
  pause010()
 print"work"
siderIntro = transition.to(slider,{time=1000, x=80, onComplete=nil})
pause1Intro = transition.to(pasue1,{time=2000, x=105, onComplete=nil})
menu101Intro = transition.to(menu101,{time=1000, x=50, onComplete=nil})
resetIntro = transition.to(reset,{time=1000, x=40, onComplete=nil})
soundIntro = transition.to(sound,{time=1000, x=60, onComplete=nil})
levelIntro = transition.to(level,{time=1000, x=80, onComplete=nil})
...
if (count == 0 and levels[4] == 2 ) then 

print "you have unlocked level 4"
...
function SaveData03 ( event )
  
print "save"

StarTableThree = {}

StarTableThree["LevelThreeStars"] = metadata.Starcount03

saveTable(StarTableThree,"LevelThreeStars.txt")
