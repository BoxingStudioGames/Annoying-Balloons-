...
balloonClass = require( "balloon Class")

balloonClass02 = require( "balloonClass02")
...
badStar01 = balloonClass02.new02()
screenGroup:insert(badStar01)

badStar02 = balloonClass02.new02()
screenGroup:insert(badStar02)

badStar03 = balloonClass02.new02()
screenGroup:insert(badStar03)
...
enemy02 = display.newSprite( sheet3, sequenceData )
enemy02.x = display.contentCenterX
enemy02.y = display.contentCenterY
--physics.addBody( enemy, "static", physicsData:get("Badman"))
---setSequence( "looking" );
enemy02:play( )
...
trans14 = transition.to( balloon08, { time =1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

------------------------stars--------------------------------
trans11 = transition.to( badStar01, { time =1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans12 = transition.to( badStar02, { time =1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans13 = transition.to( badStar03, { time =1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )
-------------------------------------------------------------------
...
trans02 = transition.to( enemy02, { time = 1000, x = math.random (70, display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil} )
...
metadata.score =metadata.score-15
--]]
gameOver();
end 
return true
...
function  starcount( event )
  print (Hit)
  print( metadata.Starcount03 )
  metadata.Starcount04 = metadata.Starcount04 +1 
...
if (count == 0 and levels[5] == 2 ) then 

print "you have unlocked level 5"
...
function SaveData04 ( event )
  
print "save"

StarTableFour = {}

StarTableFour["LevelFourStars"] = metadata.Starcount04

saveTable(StarTableFour,"LevelFourStars.txt")
...
enemy02:addEventListener( "touch", ememyTouch )
--[[

balloon05:addEventListener( "touch", balloonTouch)


balloon06:addEventListener( "touch", balloonTouch)


balloon07:addEventListener( "touch", balloonTouch)


balloon08:addEventListener( "touch", balloonTouch)
--]]
--------------------------------------------------------
badStar01:addEventListener( "touch", BadstarTouch01)
badStar02:addEventListener( "touch", BadstarTouch02)
badStar03:addEventListener( "touch", BadstarTouch03)
--------------------------------------------------------
