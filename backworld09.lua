...
brick01 = display.newImageRect("bg/brick1.png",200,570)
brick01.x = display.contentCenterX-70
brick01.y = display.contentCenterY
screenGroup:insert(brick01)

brick02 = display.newImageRect("bg/brick2.png",200,570)
...
cover1 = display.newImageRect("bg/cover.png",display.contentWidth*2,display.contentWidth*2)
...
TransMove01=transition.to(  enemy06 , { onStart = PlaySound , x = display.contentWidth+600 ,  alpha =0.10, time = 4000, delay = 2000, onComplete = Move02 } )

end

function Move02 ( )

TransMove02=transition.to(  enemy06 , { onStart =  PlaySound , x = display.contentWidth-600,  alpha = 1,time = 4000, delay = 2000,  onComplete = Move01 } )
...
if event.phase == "began"  and count == 52 then 
print "touch swirl"
cleanUp();
audio.play(soundBeep, {channel = 5})
audio.stop( Tick )
...
storyboard.gotoScene( "backworld0902", zoomOutIn,400)
