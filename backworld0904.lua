-----------------------------------------------------------------------------------------
--
-- level09.lua / back world 04/ last
--
-------------------------------------------vars----------------------------------------------
...
--local life = 3
 local count = 12
 metadata.timeLimit = 35;

metadata.Starcount09 = 0;  
...
--local  JamiacanClass = require("JamiacanClass")
...
swirl.x = display.contentCenterX
swirl.y = display.contentCenterY
screenGroup:insert(swirl)
--]]
---------------------------------------------------------------

Smoke = balloonClass.new03()
screenGroup:insert(Smoke)

Smoke1 = balloonClass.new03()
screenGroup:insert(Smoke1)
...
star1 = balloonClass.new02()
screenGroup:insert(star1)

star2 = balloonClass.new02()
screenGroup:insert(star2)

star3 = balloonClass.new02()
star3.alpha = 0.10 
...
NotHero4 = balloonClass.new04 ()
screenGroup:insert(NotHero4)

NotHero5 = balloonClass.new04 ()
screenGroup:insert(NotHero5)
--[[
NotHero6 = balloonClass.new05 ()
screenGroup:insert(NotHero6)
--]]



--------------------------------------fooling balloons-----------------------------
Smoke01 = balloonClass.new03()
Smoke01.x = display.contentCenterX
Smoke01.y = display.contentCenterY-200
Smoke01:rotate (180)
screenGroup:insert(Smoke01)

Smoke02 = balloonClass.new03()
Smoke02.x = display.contentCenterX
Smoke02.y = display.contentCenterY-200
Smoke02:rotate (180)
screenGroup:insert(Smoke02)

enemy07 = EnemyClass.new ()
enemy07.x  = display.contentCenterX
enemy07.y  =display.contentCenterY-600
--enemy06:scale( 0.80, 0.80 )
screenGroup:insert(enemy07)

badStar07 = balloonClass02.new02()
screenGroup:insert(badStar07)

badStar08 = balloonClass02.new02()
screenGroup:insert(badStar08)

badStar09 = balloonClass02.new02()
screenGroup:insert(badStar09)


----------------------------back of wall-----------------------------------

brick01 = display.newImageRect("bg/nuc02.png",190,450)
brick01.x = display.contentCenterX-93
brick01.y = display.contentCenterY
screenGroup:insert(brick01)

sign = display.newImageRect("bg/sign.png", 64,64)
sign.x = display.contentCenterX-70
sign.y = display.contentCenterY-60
screenGroup:insert(sign)

brick02 = display.newImageRect("bg/nuc01.png",190,450)
brick02.x = display.contentCenterX+93
brick02.y = display.contentCenterY
screenGroup:insert(brick02)

sign02 = display.newImageRect("bg/sign.png", 64,64)
sign02.x = display.contentCenterX+70
sign02.y = display.contentCenterY-60
screenGroup:insert(sign02)

top  = display.newImageRect( "bg/top.png", 320, 570 )
top.x = display.contentCenterX
top.y = display.contentCenterY
screenGroup:insert(top)

--[[
spot =display.newImageRect ("bg/spot.png",300,300)
spot.x = display.contentCenterX
spot.y = display.contentCenterY
screenGroup:insert(spot)
--]]
...
function  addTouch ( event )
    if event.phase  == "began" then 
        ...
        print "spwan balloons & sub tact score && time"
balloon01.alpha = 1 
balloon02.alpha = 1 
balloon03.alpha = 1 
...
metadata.score = metadata.score - 30

--metadata.timeLimit = metadata.timeLeft - 5 
...
function MoveWalls ( )
    ...
    transition.to( brick01, {x = brick01.x-300, onComplete = nil} )

    transition.to( brick02, {x = brick02.x+300, onComplete = nil} )
     
    transition.to( sign, {x = brick01.x, onComplete = nil} )

    transition.to( sign02, {x = brick02.x, onComplete = nil} )


else 

    transition.to( brick01, {x = brick01.x-20, onComplete = nil} )

    transition.to( brick02, {x = brick02.x+20, onComplete = nil} )
...
trans16 = transition.to( NotHero, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans17 = transition.to( NotHero2, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil} )

trans18 = transition.to( NotHero3, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans19 = transition.to( NotHero4, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans20 = transition.to( NotHero5, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans26 = transition.to( badStar07, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans27 = transition.to( badStar08, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans28 = transition.to( badStar09, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans30 = transition.to( star1, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans31 = transition.to( star2, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans32 = transition.to( star3, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )
 ...
 function rotate ()
    if ( reverse == 0 ) then
      print "front"
        ...
        transition.to( NotHero5, {  time=500,  alpha =0.10,  delay = 6000, transition=easing.inOutCubic } )
        --[[transition.to( balloon02, {  time=500,    alpha =1,  delay = 6000, transition=easing.inOutCubic } )
        transition.to( balloon03, {  time=500,  alpha = 1, delay = 6000, transition=easing.inOutCubic } )
        transition.to( balloon04, {  time=500,  alpha = 1, delay = 6000, transition=easing.inOutCubic } )
        transition.to( balloon05, {  time=500,  alpha = 0.10,  delay = 6000, transition=easing.inOutCubic } )
        transition.to( balloon06, {  time=500,    alpha = 1,  delay = 6000, transition=easing.inOutCubic } )
         --]]
        ...
        transition.to( balloon07, {  time=500,  alpha = 1, delay = 6000, transition=easing.inOutCubic } )
        transition.to( balloon08, {  time=500,  alpha = 1, delay = 6000, transition=easing.inOutCubic } )
      ...
      print "back"
        ...
        transition.to( NotHero5, {  time=500,  alpha = 1,  delay = 6000, transition=easing.inOutCubic } )
       --[[ transition.to( balloon02, {  time=500,    alpha = 0.10,  delay = 6000, transition=easing.inOutCubic } )
        transition.to( balloon03, {  time=500,  alpha = 0.10, delay = 6000, transition=easing.inOutCubic } )
        transition.to( balloon04, {  time=500,  alpha = 0.10, delay = 6000, transition=easing.inOutCubic } )
       --]] -----------level 12 makess the game go one for ever-----------
       --[[ 
        transition.to( balloon05, {  time=500,  alpha = 1,  delay = 6000, transition=easing.inOutCubic } )
        transition.to( balloon06, {  time=500,    alpha = 0.10,  delay = 6000, transition=easing.inOutCubic } )
        transition.to( balloon03, {  time=500,  alpha = 0.10, delay = 6000, transition=easing.inOutCubic } )
        transition.to( balloon04, {  time=500,  alpha = 0.10, delay = 6000, transition=easing.inOutCubic } )
        --]]
...
function Move01 ( )
print 'acress1'
TransMove01=transition.to(  enemy06 , { onStart = PlaySound , x = display.contentWidth+600 ,  time = 3000, delay = 3000, onComplete = Move02 } )
...
function Move02 ( )
print 'acress2'
TransMove02=transition.to(  enemy06 , { onStart =  PlaySound , x = display.contentWidth-600, time = 3000, delay = 3000,  onComplete = Move01 } )
...
function  Move03 ( )
  --print 'up 1'
  TransMove03=transition.to(  enemy07 , { onStart = PlaySound , y = display.contentCenterY-600 ,  alpha = 0.10, time = 3000, delay = 3000, onComplete = Move04 } )
...
function  Move04( )
    --print 'up 2'
   TransMove04=transition.to(  enemy07 , { onStart =  PlaySound , y = display.contentCenterY+600, alpha = 1,  time = 3000, delay = 3000,  onComplete = Move03 } )
 

end

MoveAcross01=timer.performWithDelay( 5000, Move03, 1 ) 
...
warn=audio.play(soundEnmey02, {channel = 6})
--audio.fadeOut(soundEnmey, {time= 3000 } );
--audio.setMaxVolume( 1, {channel=5} )
...
if event.phase == "began"  and count == 8 then 
print "touch swirl"
cleanUp();
audio.play(soundBeep, {channel = 5})
audio.stop( Tick )
...
storyboard.gotoScene( "backworld0904", zoomOutIn,400)
...
function  starcount( event )
  ...
  print( metadata.Starcount09 )
  metadata.Starcount09 = metadata.Starcount09 +1 
...
transition.pause( trans16)
transition.pause( trans17)
transition.pause( trans18)
transition.pause( trans19)
transition.pause( trans20)
...
transition.pause( trans21)
transition.pause( trans22)
transition.pause( trans23)
transition.pause( trans24)
transition.pause( trans25)

transition.pause( trans30)
transition.pause( trans31)
transition.pause( trans32)
...
transition.pause( TransMove03)
transition.pause( TransMove04)
timer.pause( timer01  )
timer.pause( moveBack )
timer.pause( MoveAcross01 )
...
transition.pause(trans26 )
transition.pause(trans27 ) 
transition.pause(trans28 ) 
transition.pause( trans29)
...
transition.resume( TransMove03)
transition.resume( TransMove04)
timer.resume(  MoveAcross )
timer.resume( MoveAcross01 )
timer.resume( ID1 )
timer.resume( ID2 )
timer.resume( ID3 )
timer.resume( ID4 )
...
transition.resume(trans26 )
transition.resume(trans27 ) 
transition.resume(trans28 )

transition.resume(trans29) 

transition.resume( trans30)
transition.resume( trans31)
transition.resume( trans32)
...
transition.resume( trans16)
transition.resume( trans17)
transition.resume( trans18)
transition.resume( trans19)
transition.resume( trans20)
...
transition.cancel( trans16)
transition.cancel( trans17)
transition.cancel( trans18)
transition.cancel( trans19)
transition.cancel( trans20)
...
transition.cancel(TransMove03)
transition.cancel( TransMove04)

transition.cancel( trans30)
transition.cancel( trans31)
transition.cancel( trans32)

transition.cancel(trans26 )
transition.cancel(trans27 ) 
transition.cancel(trans28 ) 
transition.cancel(trans29 ) 
...
if (count == 0 and levels[10] == 2 ) then 

print "you have unlocked level 10"
...
function  SaveData09 ( event )
  
  StarTableNine = {}

  print ("Every Is okay on level 9 ");

StarTableNine["LevelNineStars"] = metadata.Starcount09

 saveTable (StarTableNine,"LevelNineStars.txt")
...
brick01:addEventListener( "touch", bickwallTouch )

brick02:addEventListener( "touch", bickwallTouch )
end
...
brick01:removeEventListener( "touch", bickwallTouch )

brick02:removeEventListener( "touch", bickwallTouch )

balloon01:removeEventListener( "touch", balloonTouch )

balloon02:removeEventListener( "touch", balloonTouch )

balloon03:removeEventListener( "touch", balloonTouch )

balloon04:removeEventListener( "touch", balloonTouch )
