...
--------------------------------------------------------------
local voice01 = audio.loadSound ("music/voice01.mp3")
local voice02 = audio.loadSound ("music/voice02.mp3")
local voice03 = audio.loadSound ("music/voice03.mp3")
local voice04 = audio.loadSound ("music/voice04.mp3")
local voice05 = audio.loadSound ("music/voice05.mp3")
local soundBeep = audio.loadSound ("music/beep.mp3")
local availableChannel = audio.findFreeChannel()
local backgroundMusic02 = audio.loadStream("music/everylittle.mp3")  
...
-- background 
 local background = display.newImageRect("bg/beach.png", 320, 570)
...
balloon05 = JamiacanClass.new ()
balloon05:scale( 1, 1 )
screenGroup:insert(balloon05)

balloon06 = JamiacanClass.new ()
balloon05:scale( 1,1 )
screenGroup:insert(balloon06)

balloon07 = JamiacanClass.new ()
balloon07:scale( 1, 1 )
 screenGroup:insert(balloon07)

balloon08 = JamiacanClass.new ()
balloon08:scale( 1, 1 )
screenGroup:insert(balloon08)

balloon09 = JamiacanClass.new ()
balloon09: scale( 1, 1 )
 screenGroup:insert(balloon09)

balloon010 = JamiacanClass.new ()
balloon010:scale( 1, 1 )
 screenGroup:insert(balloon010)

  balloon011 = JamiacanClass.new ()
  balloon011:scale( 1, 1 )
 screenGroup:insert(balloon011)

  balloon012 = JamiacanClass.new ()
  balloon012:scale( 1, 1 )
...
Blackstar01 = balloonClass02.new02()
screenGroup:insert(Blackstar01)

Blackstar02 = balloonClass02.new02()
screenGroup:insert(Blackstar02)

Blackstar03 = balloonClass02.new02()
screenGroup:insert(Blackstar03)
...
enemy05 = EnemyClass.new ()
enemy05.x = display.contentCenterX
enemy05.y=  display.contentCenterY*40
...
cover1 = display.newImage("bg/cover.png",display.contentWidth*2,display.contentHeight*2)
...
backgroundMusicChannel02 = audio.play( backgroundMusic02, { channel=12, loops=-1, fadein=4000 }  )
audio.setMaxVolume( 10, {channel=12} )
end

timer.performWithDelay( 1000, backgroundMusicPlay, 1 )
...
trans16 = transition.to( star1, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans17 = transition.to( star2, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans18 = transition.to( star3, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )
...
trans06 = transition.to( Blackstar01, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70, display.contentHeight), onComplete = nil } )

trans07 = transition.to( Blackstar02, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70, display.contentHeight), onComplete = nil } )

trans08 = transition.to( Blackstar03, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70, display.contentHeight), onComplete = nil } )
 ...
 function rotate ()
    if ( reverse == 0 ) then
      print "front"
        ...
        transition.to( enemy01, { rotation=-360, time=500, transition=easing.inOutCubic } )
        transition.to( enemy02, { rotation=-360, time=500,  delay = 3000, transition=easing.inOutCubic } )
        transition.to( enemy03, { rotation=-360, time=500,  delay = 6000, transition=easing.inOutCubic } )
        transition.to( enemy, { rotation=-360, time=500,  delay = 6000, transition=easing.inOutCubic } )
        transition.to( enemy04, { rotation=-360, time=500,  delay = 6000, transition=easing.inOutCubic } )
        
        transition.to( badStar04, { rotation=-360, time=500, transition=easing.inOutCubic } )
        transition.to( badStar05, { rotation=-360, time=500,  delay = 3000, transition=easing.inOutCubic } )
        transition.to( badStar06, { rotation=-360, time=500,  delay = 6000, transition=easing.inOutCubic } )
         

        transition.to( star1, { rotation=-360, time=500, transition=easing.inOutCubic } )
        transition.to( star2, { rotation=-360, time=500,  delay = 3000, transition=easing.inOutCubic } )
        transition.to( star3, { rotation=-360, time=500,  delay = 6000, transition=easing.inOutCubic } )
      ...
      print "back"
        ...
        transition.to( Blackstar01, { rotation=360, time=500, transition=easing.inOutCubic } )
        transition.to( Blackstar02, { rotation=360, time=500,  delay = 3000, transition=easing.inOutCubic } )
        transition.to( Blackstar03, { rotation=360, time=500,  delay = 6000, transition=easing.inOutCubic } )
...
moveBack=timer.performWithDelay( math.random(4000,7000), rotate, 0 )  -- Repeat forever

function Move01 ( )

TransMove01=transition.to(  enemy05 , { onStart = PlaySound , y = display.contentWidth+600 , time = 2000, delay = 1000, onComplete = Move02 } )

end

function Move02 ( )

TransMove02=transition.to(  enemy05 , { onStart =  PlaySound , y = display.contentWidth-600, time = 2000, delay = 1000,  onComplete = Move01 } )
 
end


MoveAcross=timer.performWithDelay( 3000, Move01, 1 ) 
...
storyboard.gotoScene( "level08backworld02", zoomOutIn,400)
...
function  starcount( event )
  ...
  print( metadata.Starcount08 )
  metadata.Starcount08 = metadata.Starcount08 +1 
...
audio.pause( backgroundMusicChannel02 )
...
timer.resume( ID5 )
timer.resume( ID6 )
audio.resume( voiceMe )
audio.resume( backgroundMusicChannel02 )
balloon01:play( )
balloon02:play( )
balloon03:play( )
balloon04:play( )
...
audio.stop( voiceMe )
audio.stop( Tick )
audio.stop(backgroundMusicChannel02)
...
if (count == 0 and levels[9] == 2 ) then 

print "you have unlocked level 9"
...
function  SaveData08 ( event )
  
  StarTableEight = {}

  print ("Every Is okay on level 8 ");

StarTableEight["LevelEightStars"] = metadata.Starcount08

 saveTable (StarTableEight,"LevelEightStars.txt")
...
Mp3Table  = {voice01,voice02, voice03,voice04,voice05}

function VoiceSound ( event )

VoiceIndex = math.random(#Mp3Table)

voiceMe=audio.play( Mp3Table[VoiceIndex], { channel = 7,  onComplete =  nil } )



end
local total  = 0 
timer02=timer.performWithDelay( 10000, VoiceSound, total )
