-----------------------------------------------------------------------------------------
--
-- level012.lua/ fianal level of world / 02/ done / last level of all 
--
-------------------------------------------vars----------------------------------------------
...
-- background
 ...
 local background = display.newImageRect("bg/last.png", 320, 570)
...
NotStar = display.newImageRect("images/bad01.png",64,64)
NotStar.x = display.contentCenterX
NotStar.y = display.contentCenterY
NotStar:scale( 0.80, 0.80 )
screenGroup:insert(NotStar)

NotStar01 = display.newImageRect( "images/bad01.png",64,64)
NotStar01.x = display.contentCenterX
NotStar01.y = display.contentCenterY
NotStar01:scale( 0.80, 0.80 )
screenGroup:insert(NotStar01)

NotStar02 = display.newImageRect( "images/notHero08.png",64,64)
NotStar02.x = display.contentCenterX
NotStar02.y = display.contentCenterY
NotStar02:scale( 0.80, 0.80 )
screenGroup:insert(NotStar02)
...
enemy06:translate( display.contentCenterX, display.contentCenterY )
...
trans14 = transition.to( star1, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans15 = transition.to( star2, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans16 = transition.to( star3, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )
...
trans08 = transition.to( NotStar, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70, display.contentHeight), onComplete = nil } )

trans09 = transition.to( NotStar01, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70, display.contentHeight), onComplete = nil } )

trans010 = transition.to( NotStar02, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70, display.contentHeight), onComplete = nil } )
 ...
 function rotate ()
    if ( reverse == 0 ) then
      ...
      print "back"
        ...
        transition.to( enemy06,{ rotation=360, time=500, xScale= 0.9, yScale = 0.9,  alpha =  0.10, delay = 6000, transition=easing.inOutCubic } )
...
storyboard.gotoScene( "backworld012", zoomOutIn,400)
...
function  starcount( event )
  ...
  print( metadata.Starcount012 )
  metadata.Starcount012 = metadata.Starcount012 +1 
...
-----------------unlock world 2-----------------------------
--[[
if (count == 0 and levels[11] == 2 ) then 

print "you have unlocked level 11"
...
function  SaveData012 ( event )
  
  StarTableTwelve = {}

  print ("Every Is okay on level 12 ");

StarTableTwelve["LevelTwelveStars"] = metadata.Starcount012

 saveTable (StarTableTwelve,"LevelTwelveStars.txt")
...
ID1=timer.performWithDelay( math.random(2000,4000), helpers, 1)
...
ID2=timer.performWithDelay( math.random(5000,70000), helpers02, 1)
...
ID3=timer.performWithDelay( math.random(5000,10000), helpers03, 1)
------------------------------------------------------------------------
...
ID5=timer.performWithDelay( math.random(5000,7000), helpers05, 1)
...
ID6=timer.performWithDelay( math.random(5000,10000), helpers06, 1)
...
NotStar:addEventListener("touch",ememyTouch)

NotStar01:addEventListener("touch",ememyTouch)

NotStar02:addEventListener("touch",ememyTouch)
...
NotStar:removeEventListener("touch",ememyTouch)

NotStar01:removeEventListener("touch",ememyTouch)

NotStar02:removeEventListener("touch",ememyTouch)
