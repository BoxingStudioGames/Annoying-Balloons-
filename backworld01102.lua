-----------------------------------------------------------------------------------------
--
-- level011.lua/ first point of darkness
--
-------------------------------------------vars----------------------------------------------
...
--local life = 3
 local count = 6
 metadata.timeLimit = 15;

metadata.Starcount011 = 0;  
...
-- include Corona's "physics" libeary
...
-- background
 ...
 local background = display.newImageRect("bg/swirl bg3.png", 320, 570)
...
trans10 = transition.to( star1, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans11 = transition.to( star2, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil } )

trans12 = transition.to( star3, { time = 1000, x = math.random (70,display.contentWidth), y = math.random (70,display.contentHeight), onComplete = nil} )
--[[
...
trans05 = transition.to( enemy04, { time = 100.90, x = math.random (70,display.contentWidth), y = math.random (70, display.contentHeight), onComplete = nil } )

trans06 = transition.to( enemy05, { time = 100.80, x = math.random (70,display.contentWidth), y = math.random (70, display.contentHeight), onComplete = nil } )

trans07 = transition.to( enemy06, { time = 100, x = math.random (70,display.contentWidth), y = math.random (70, display.contentHeight), onComplete = nil } )
...
if event.phase == "began"  and count == 18 then 
print "touch swirl"
cleanUp();
audio.play(soundBeep, {channel = 5})
audio.stop( Tick )
...
storyboard.gotoScene( "backworld01101", zoomOutIn,400)
...
function  starcount( event )
  ...
  print( metadata.Starcount011 )
  metadata.Starcount011 = metadata.Starcount011 +1 
...
if (count == 0 and levels[12] == 2 ) then 

print "you have unlocked level 12 and congrates your on your final level"
...
function  SaveData011 ( event )
  
  StarTableEleven = {}

  print ("Every Is okay on level 11 ");

StarTableEleven["LevelElevenStars"] = metadata.Starcount011

 saveTable (StarTableEleven,"LevelElevenStars.txt")
