...
local backgroundMusic = audio.loadStream("music/Jamming.mp3")  
...
-- background 
 local background = display.newImageRect("bg/level 5.png", 320, 570)
...
backgroundMusicChannel = audio.play( backgroundMusic, { channel=11, loops=-1, fadein=4000 }  )
audio.setMaxVolume( 20, {channel=11} )
