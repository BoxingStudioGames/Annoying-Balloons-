-----------------------------------------------------------------------------------------
--
-- level010.lua/ bacckworld05 / last
--
-------------------------------------------vars----------------------------------------------
...
-- background 
 local background = display.newImageRect("bg/swirl bg2.png", 320, 570)
...
storyboard.gotoScene( "backworld0105", zoomOutIn,400)
...
function  starcount( event )
  ...
  print( metadata.Starcount010 )
  metadata.Starcount010 = metadata.Starcount010 +1 
...
function  SaveData010 ( event )
  
  StarTableTen = {}

  print ("Every Is okay on level 10 ");

StarTableTen["LevelTenStars"] = metadata.Starcount010

 saveTable (StarTableTen,"LevelTenStars.txt")
