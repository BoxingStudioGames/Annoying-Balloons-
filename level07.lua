...
transition.to( event.target, { time = 10, alpha = 0, onComplete = nil} ); 
 metadata.score  = metadata.score + 50
 scoreText.text = metadata.score
...
storyboard.gotoScene( "house02", zoomOutIn,400)
...
coverIntro = transition.to(cover1,{time=10, x=display.contentCenterX*7, onComplete=nil})
