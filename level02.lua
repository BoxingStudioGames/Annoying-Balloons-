...
timer02=timer.performWithDelay( math.random(1000,10000), player, 0 )
--]]
...
audio2 = audio.play( soundFile,{channel = 1, onComplete = nil} )
...
function  starcount( event )
  print ("Hit")
  print( metadata.Starcount02 )
  metadata.Starcount02 = metadata.Starcount02 +1 
...
function timerDown()
 ...
 Audio1=audio.play( soundClock,{channel = 1, onComplete = nil} )
...
if (count == 0 and levels[3] == 2 ) then 
...
function  win ( event )
 SaveData02 ();
cleanUp ();
storyboard.gotoScene("win",slideRight,300)
...
function SaveData02 ( event )
  
print "save"

StarTableTwo = {}

StarTableTwo["LevelTwoStars"] = metadata.Starcount02

saveTable(StarTableTwo,"LevelTwoStars.txt")
